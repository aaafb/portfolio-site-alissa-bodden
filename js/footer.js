class FooterComponent extends HTMLElement {
  connectedCallback() {
    ...
    <div class="logo">
      <a href="index.html"
        ><img src="img/logo.svg" alt="Alissa Bodden Home" /><span
          >Alissa Bodden</span
        ></a
      >
    </div>
    ...
    <p class="footer-blurb">
      Thanks for visiting my website! I designed and built it with love, Figma,
      and HTML (plus Claude.ai, sweat, and maybe a few tears).
    </p>
